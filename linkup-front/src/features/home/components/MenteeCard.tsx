      ...
      <div className="flex flex-col items-center justify-between flex-1 gap-2 text-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div
              className={`text-[11px] font-medium line-clamp-1 text-center h-8 flex items-center justify-center ${COMMON_STYLES.TEXT_SECONDARY} ${COMMON_STYLES.TRANSITION_COLORS}`}
            >
              {mentee.age}세
            </div>
          </div>
